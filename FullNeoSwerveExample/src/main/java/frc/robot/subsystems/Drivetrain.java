...
public class Drivetrain extends SubsystemBase {
  ...
  public void periodic() {
    ...
    // SmartDashboard.putNumber("Alpha", m_fieldRelAccel.alpha);
     ...
     SmartDashboard.putNumber("Front Left Speed", m_frontLeft.getModuleState().speedMetersPerSecond);
     SmartDashboard.putNumber("Front Right Speed",m_frontRight.getModuleState().speedMetersPerSecond);
     SmartDashboard.putNumber("Back Left Speed", m_rearLeft.getModuleState().speedMetersPerSecond);
     SmartDashboard.putNumber("Back Right Speed", m_rearRight.getModuleState().speedMetersPerSecond);
  ...
  public ChassisSpeeds getChassisSpeed() {
    return DriveConstants.kDriveKinematics.toChassisSpeeds(m_frontLeft.getModuleState(), m_frontRight.getModuleState(),
